...
<body class="login-page">
    ...
    <!-- Modal -->
    <div class="modal fade" id="Life_ring" tabindex="-1" role="dialog" aria-labelledby="Life_ring_Label" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary" style="padding: 0.7rem;">
                    <h5 class="modal-title" id="Life_ring_Label">แก้ไขหมายเลขห่วงยาง</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div id="Life_ring_display"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="Edit_Other" tabindex="-1" role="dialog" aria-labelledby="Edit_Other_Label" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary" style="padding: 0.7rem;">
                    <h5 class="modal-title" id="Edit_Other_Label">แก้ไขสถานที่ อื่นๆ</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div id="Edit_Other_display_key"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="trianner_emp_select_modal" tabindex="-1" role="dialog" aria-labelledby="trianner_emp_select_modal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary" style="padding: 0.7rem;">
                ...
                <div class="modal-body">
                    <div id="Display_select_trainner_emp"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="trianner_emp_select_modal_edit" tabindex="-1" role="dialog" aria-labelledby="trianner_emp_select_modal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary" style="padding: 0.7rem;">
                    <h5 class="modal-title">เลือกผู้สอน</h5>
                ...
                <div class="modal-body">
                    <div id="Display_select_trainner_emp_edit"></div>
                </div>
            </div>
        </div>
    </div>
